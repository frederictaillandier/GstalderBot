...
class NotificationProducer:
    ...
    def send_weekly_schedule(self):
        ...
        food_master_chat_sender = TelegramSender(
            self.config["bot_token"], self.food_master_finder.get_current()["chat_id"]
        )
    ...
    def send_daily_schedule(self):
        ...
        schedule = self.trash_schedule_grabber.get_schedule(datetime.datetime.today())
        ...
        daily_schedule_text = self.message_formater.get_daily_update_text(trashes)
