...
import datetime
import message_formater as MessageFormater
import telegram_sender as TelegramSender
...
class NotificationProducer:
    ...
    def __init__(self, food_master_finder, trash_schedule_grabber, config):
        ...
        self.message_formater = MessageFormater.MessageFormater(
    ...
    def send_food_master_change(self):
        ...
        telegram_sender = TelegramSender.TelegramSender(
            self.config["bot_token"],
            self.config["global_chat_id"]
        )
        telegram_sender.send_message(introduction_text)
    ...
    def send_weekly_schedule(self):
        ...
        food_master_chat_sender = TelegramSender.TelegramSender(
            self.config["bot_token"],
    ...
    def send_daily_schedule(self):
        ...
        food_master_chat_sender.send_message(daily_schedule_text)
